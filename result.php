...
$paymentResult = isset($_GET['result']) ? $_GET['result'] : 'failure';

$title = '<span class="text-danger">Pago rechazado</span> 😬';
$content = 'Lamentamos decirte que tu pago ha sido rechazado.';
...
switch ($paymentResult) {
    case 'success':
        ...
        break;
    case 'pending':
        $title = 'Compra pendiente de Pago 😉';
        $content = 'Quedamos a la espera de que finalice su pago.';
        break;
    case 'failure':
        $title = '<span class="text-danger">Pago rechazado</span> 😬';
        $content = 'Lamentamos decirte que tu pago ha sido rechazado.';
...
<head>
    ...
    <style>
        ...
        .button {
            padding: 0.8em 1.7142857142857142em;
        }
        .text-success{
            color: green;
        }
                ...
                <div id="accessories-tab" class="as-accessories-details">
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <p class="mb-15 mt-2"><?php echo $content; ?></p>
                        </div>
                    </div>
                </div>
            </div>
